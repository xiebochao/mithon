...
Blockly.Arduino.ADS1015_setGain = function() {
  ...
  Blockly.Arduino.definitions_['Adafruit_ADS1015_ads'] = 'Adafruit_ADS1015 ads;\n';

  if(!Blockly.Arduino.setups_['setup_ads.begin()']) {  Blockly.Arduino.setups_['setup_ads.begin()'] = 'ads.begin(); \n';}
...
Blockly.Arduino.ADS1015_Get_Value = function() {
  ...
  Blockly.Arduino.definitions_['include_Adafruit_ADS1015'] = '#include <Adafruit_ADS1015.h>';
  Blockly.Arduino.definitions_['Adafruit_ADS1015_ads'] = 'Adafruit_ADS1015 ads;\n';
  if(!Blockly.Arduino.setups_['setup_ads.begin()']){
