...
try {
    ...
    if (MixlyUrl.BOARD_CONFIG.hasOwnProperty("ThirdPartyBoard") && MixlyUrl.BOARD_CONFIG["ThirdPartyBoard"].toLowerCase() == "true") {
	    navById.innerHTML = `
...
function navInit() {
	...
	if (MixlyUrl.BOARD_CONFIG.hasOwnProperty("nav.simulate") && MixlyUrl.BOARD_CONFIG.hasOwnProperty("BoardName") && MixlyUrl.BOARD_CONFIG["BoardName"] == "Arduino AVR" && MixlyUrl.BOARD_CONFIG["nav.simulate"].toLowerCase() == "true") {
		dataHead += '<dd lay-unselect><a href="#" onclick="MixlyAvrSimulate.initSimulate();" id="operate_simulate_btn" class="icon-play-circled">仿真</a></dd>\n';
		dataTail += '<li class="layui-nav-item" id="li_simulate" lay-unselect><a href="#" id="simulate_btn" onclick="MixlyAvrSimulate.initSimulate();" class="icon-play-circled" ></a></li>\n';
	}
	...
	if (MixlyUrl.BOARD_CONFIG.hasOwnProperty("nav.setting.thirdPartyLibrary") && MixlyUrl.BOARD_CONFIG["nav.setting.thirdPartyLibrary"].toLowerCase() == "true") {
		...
		<dd lay-unselect><a href="#" id="manage_libraries_btn" class="icon-menu" onclick="manageLibraries();"></a></dd>
		`;
	}
	dataTail += "</dl>\n</li>\n";
	dataTail += `
