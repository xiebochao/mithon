...
var microbitFsWrapper = function() {
    ...
    fsWrapper.setupFilesystem = function() {
        if (Mixly_20_environment) {
            ...
            var deferred1 = $.get('../../board/common/micropython/microbit-micropython-v1.hex', function(fileStr) {
                uPyV1 = fileStr;
            }).fail(function() {
                console.error('Could not load the MicroPython v1 file.');
            });
            var deferred2 = $.get('../../board/common/micropython/microbit-micropython-v2.hex', function(fileStr) {
                uPyV2 = fileStr;
            }).fail(function() {
