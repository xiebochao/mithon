...
Blockly.Events.fire = function (event) {
  ...
  if(event instanceof Blockly.Events.Ui){ // event object is a block
    ...
    /*$.post("http://gojtp6.com/index/news/send?uid="+uid,{"data":recordLine},function (res) {
          window.actionArrayRecord = [];
              },'json');*/
    /*$.post("../../event.php?uid="+1,{"data":recordLine},function (res) {
          window.actionArrayRecord = [];
              },'json');  */
    ...
    if(!(event instanceof Blockly.Events.Move && currentCode === Blockly.lastCode)){
      ...
      /*$.post("http://123.57.14.141/index/news/send?uid="+uid,{"data":recordLine},function (res) {
          window.actionArrayRecord = [];
              },'json');*/
      window.actionArrayRecord.push(recordLine);
    }
 ...
 if(window.actionArrayRecord.length>10){
    ...
    $.post("../../event.php",{"data":JSON.stringify(window.actionArrayRecord),"fileName":fileName},function (res) {
          window.actionArrayRecord = [];
              },'json');
    window.actionArrayRecord = [];
  };
